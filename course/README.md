...
| Corp Portal — Recuperación † | Web / Auth | [Password reset & account recovery attacks](../notes/web-security/insecure-password-reset.md) |
| Corp API † | Web / API | [JWT attacks](../notes/web-security/jwt-attacks.md) |
